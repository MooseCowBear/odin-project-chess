module Neighbors 
  def closest_neighbors(board:, square:, color:) #color is color of piece on square, hypothetical or not
    opponents = []
    teammates = []
    ...
    directions.each do |dir|
      ...
      if board.get_piece(position: closest_neighbor)&.opponent?(color)
